...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (openai) {
      try {
        ...
        const completion = await openai.chat.completions.create({
          ...
          messages: [
            { 
              role: "system", 
              content: "Tu es un générateur de code HTML. Réponds UNIQUEMENT avec du code HTML/CSS/JS valide. Utilise Tailwind CSS via CDN. Contenu en français. Ne met aucun texte explicatif, seulement du code." 
            },
            { 
              role: "user", 
              content: `Crée une page HTML complète pour: ${prompt}. Inclus Tailwind CSS via CDN.` 
            }
          ],
          temperature: 0.7,
          max_tokens: 2000,
        ...
        if (html && (html.includes('<!DOCTYPE') || html.includes('<html') || html.includes('<div') || html.includes('<body'))) {
          usedAI = true;
          ...
          usedAI = false;
          errorMessage = "Pas de HTML valide retourné";
        }
      ...
      errorMessage = "Bonsai non configuré";
    }
...
<body class="bg-gray-50 min-h-screen">
    <nav class="bg-white shadow-lg">
        <div class="container mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-bold text-blue-600">${prompt}</h1>
                <div class="space-x-4">
    ...
    <main class="container mx-auto px-4 py-12">
        <div class="text-center mb-12">
            <h2 class="text-4xl font-bold text-gray-800 mb-4">Bienvenue sur ${prompt}</h2>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <h3 class="text-xl font-bold mb-2">Design responsive moderne</h3>
        ...
        <div class="bg-blue-50 p-8 rounded-2xl text-center">
            <h3 class="text-2xl font-bold text-blue-700 mb-4">🚀 Généré par Elina AI ✨</h3>
            <p class="text-blue-600">${usedAI ? 'Avec intelligence artificielle' : 'Avec template (fallback)'}</p>
            ${errorMessage ? `<p class="text-red-500 mt-2">Erreur: ${errorMessage}</p>` : ''}
        </div>
    </main>
    ...
    <footer class="bg-gray-800 text-white py-8 mt-12">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="mt-2 text-gray-400">Développé avec Next.js et Tailwind CSS</p>
        </div>
    </footer>
</body>
</html>`;
    ...
    return NextResponse.json({
      ...
      html: html,
      hasAI: usedAI,
      message: usedAI ? "Généré avec Bonsai AI" : "Généré avec template (fallback)"
    });
